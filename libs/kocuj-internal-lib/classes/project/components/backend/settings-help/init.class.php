...
class Init extends ComponentInitObject
{
    ...
    public function __construct($projectObj)
    {
        ...
        // set errors
        $this->errors = array(
            ExceptionCode::HELP_ID_EXISTS => 'Help identifier for the selected settings menu already exists',
            ExceptionCode::HELP_ID_DOES_NOT_EXIST => 'Help identifier does not exist',
